 ...
 */
package com.yangqiang.game.config.parser;

import com.yangqiang.game.config.IConverter;
import com.yangqiang.game.config.beans.ColumnDesc;
import com.yangqiang.game.config.beans.TableDesc;
import com.yangqiang.game.config.util.ReflectUtils;
...
import static com.yangqiang.game.config.parser.XmlElement.*;
                ...
                while (configElementIt.hasNext()) {
                    ...
                    if (index != null && !index.trim().isEmpty()) {
                        try {
                            ...
                            throw new RuntimeException(StringUtil.format("[{}]对应配置的index错误:{}", clz.getName(), index));
                        }
                    }
                    ...
                    if (header != null && !header.trim().isEmpty()) {
                        try {
                            ...
                            throw new RuntimeException(StringUtil.format("[{}]对应配置的header错误:{}", clz.getName(), header));
                        }
                    }
                    ...
                    if (ignoreRowStr != null && !ignoreRowStr.trim().isEmpty()) {
                        ...
                        try {
                            ...
                            throw new RuntimeException(StringUtil.format("[{}]对应配置的ignoreRow错误:{}", clz.getName(), ignoreRowStr));
                        }
                    ...
                    while (fieldElementIt.hasNext()) {
                        ...
                        if (fieldName == null || fieldName.trim().isEmpty()) {
                            throw new RuntimeException(StringUtil.format("[{}]中field节点name属性不能为空", clz.getName()));
                        }
                        ...
                        try {
                            ...
                            throw new RuntimeException(StringUtil.format("[{}]的属性字段[{}]不存在", clz.getName(), fieldName));
                        ...
                        if (converters != null && !converters.isEmpty()) {
                            ...
                            if (converterClzName == null || converterClzName.trim().isEmpty()) {
                                throw new RuntimeException(StringUtil.format("[{}]的属性字段[{}]存在一个空的converter配置", clz.getName(), fieldName));
                            }
                            ...
                            for (int i = 1; i < converters.size(); i++) {
                                ...
                                if (converterClzName == null || converterClzName.trim().isEmpty()) {
                                    throw new RuntimeException(String.format("[{}]的属性字段[{}]存在一个空的converter配置", clz.getName(), fieldName));
                                }
